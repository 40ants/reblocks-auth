# -*- coding: utf-8 -*-
#
# weblocks-auth documentation build configuration file, created by
...
htmlhelp_basename = 'weblocks-authdoc'
...
latex_documents = [
  ('index', 'weblocks-auth.tex', u'weblocks-auth Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'weblocks-auth', u'weblocks-auth Documentation',
     [u''], 1)
]
...
texinfo_documents = [
  ('index', 'weblocks-auth', u'weblocks-auth Documentation',
   u'', 'weblocks-auth', 'A system to add an authentication to the Weblocks based site.',
   'Miscellaneous'),
]
